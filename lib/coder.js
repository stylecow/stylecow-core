...
stylecow.Coder = class {
    constructor (css, options) {
        ...
        if (typeof options.style === 'object') {
            Object.keys(styles.normal).forEach(function(i) {
                if (!(i in options.style)) {
            ...
            this.style = styles[options.style || 'normal'];
        }
            ...
            if (options.previousSourceMap === undefined) {
                ...
                if (comment) {
                    ...
                    if (inlineSourceMap.indexOf('data:application/json;base64,') === 0) {
                        ...
                        let rel = path.resolve(stylecow.cwd(), path.dirname(css.getData('sourceFile')) || '');
