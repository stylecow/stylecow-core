...
class NodeCollection extends mix(require('./collection'), require('./node')) {
    ...
    pushCode (code, className, constructor) {
        this.push(stylecow.parse(code, className, constructor));
    }
    ...
    unshiftCode (code, className, constructor) {
        this.unshift(stylecow.parse(code, className, constructor));
    }
