...
class Node {
    ...
    codeBefore (code, className, constructor) {
        this.before(stylecow.parse(code, className, constructor));
    }
    ...
    codeAfter (code, className, constructor) {
        this.after(stylecow.parse(code, className, constructor));
    }
