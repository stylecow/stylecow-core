...
export default class NestedAtRule extends NodeCollectionVendor {
    ...
    static create (reader, parent) {
        ...
        if (reader.currToken === AT && reader.nextToken === NAME) {
            ...
            const element = (new NestedAtRule(reader.data())).setNameWithVendor(reader.getStringAndMove());
            ...
            switch (element.name) {
                ...
                case 'supports':
                    element.push(ConditionalSelector.create(reader, element) || reader.error());
                    break;
