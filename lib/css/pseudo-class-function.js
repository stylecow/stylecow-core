...
export default class PseudoClassFunction extends NodeCollectionVendor {
    ...
    static create (reader, parent) {
        if (reader.currToken === COLON && reader.nextToken === NAME && reader.nextNextToken === OPEN_PARENTHESIS) {
            ...
            const element = (new PseudoClassFunction(reader.data())).setNameWithVendor(reader.getStringAndMove());
            ...
            //Contains position
                ...
                // an+b
                    ...
                    if (reader.currToken === NUMBER && reader.nextToken === NAME && reader.nextStr === 'n') {
                        ...
                        const unit = (new Unit(reader.data())).setName(reader.getStringAndMove());
