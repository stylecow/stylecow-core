...
stylecow.Selector = class extends require('../../classes/node-collection') {
	...
	static create (reader) {
		...
		do {
			if (reader.currToken[0] === CLOSE_PARENTHESIS || reader.currToken[0] === OPEN_CURLY_BRACKET || reader.currToken[0] === SEMICOLON) {
				break;
			}
		...
		} while (reader.currToken[0] !== COMMA && reader.currToken[0] !== EOF);
