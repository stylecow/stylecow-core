(function (stylecow) {
	...
	stylecow.Value.create = function (reader) {
		...
		do {
			if (reader.currToken[0] === t.CLOSE_PARENTHESIS || reader.currToken[0] === t.EXCLAMATION || reader.currToken[0] === t.SEMICOLON || reader.currToken[0] === t.CLOSE_CURLY_BRACKET || reader.currToken[0] === t.COMMA || reader.currToken[0] === t.EOF) {
				break;
			}
