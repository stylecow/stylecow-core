(function (stylecow) {
    ...
    require('./css/conditional-selectors/conditional-feature-boolean');
    require('./css/conditional-selectors/conditional-feature-range');

    // @-rules
    require('./css/at-rules/document');
    require('./css/at-rules/at-rule');
    require('./css/at-rules/nested-at-rule');
    ...
    //Execute tests cases
    stylecow.testCases = function (dir, test, cases) {
        var fs = require('fs');
        var path = require('path');
        cases = cases || fs.readdirSync(dir);
