(function (stylecow) {
    ...
    stylecow.Reader.prototype = {
        ...
        isNested: function () {
            ...
            var bracketPos = this.code.indexOf('{', this.pos);

            if (bracketPos === -1) {
                return false;
            }

            var semicolonPos = this.code.indexOf(';', this.pos);

            if (semicolonPos === -1) {
                return true;
            }

            return (bracketPos < semicolonPos && bracketPos < this.code.indexOf('}', this.pos));
        },
