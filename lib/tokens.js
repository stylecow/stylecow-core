...
t.prototype = {
    ...
    END: function () {
        if (this.currChar === '') {
            return [t.EOF, this.col, this.line];
        }

        return [t.UNKNOWN, this.col, this.line];
    ...
    WHITESPACE: function () {
        if (this.currChar === ' ' || this.currChar === '\t' || this.currChar === '\n') {
            ...
            return [t.WHITESPACE, this.col, this.line];
        }
    },

    SPECIAL_CHAR: function () {
        if (this.currChar in specialChars) {
            return [specialChars[this.currChar], this.col, this.line];
        }
    },
